...
#pragma mark - anjohnlv custom
+ (void)showHUD {
    UIWindow *window = [UIApplication sharedApplication].keyWindow;
    MBProgressHUD *old = [self HUDForView:window];
    if (old != nil) {
        old.removeFromSuperViewOnHide = YES;
        [old hideAnimated:YES];
    }
...
+ (void)showMessage:(NSString *)msg{
    [self showMessage:msg autoHidden:YES];
}
